    ...
    <section className="py-24 bg-gradient-to-b from-gray-50 to-gray-200">
      <div className="container max-w-screen-lg mx-auto text-center">
        ...
        <p className="text-xl text-gray-700 mb-16">
          Enter the number of applications below to calculate your cost and see the benefits you’ll receive. Fill in the form to get started.
        </p>

        <div className="bg-white shadow-2xl rounded-3xl p-12 mb-12">
          <div className="mb-10">
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-xl rounded-2xl p-10 space-y-6">
          <h3 className="text-3xl font-bold text-black mb-4">Contact Us</h3>
          <div>
